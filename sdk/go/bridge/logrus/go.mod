module github.com/nephele/vortiq-go-sdk/bridge/logrus

go 1.23.0

toolchain go1.24.0

replace github.com/nephele/vortiq-go-sdk => ../..

require (
	github.com/nephele/vortiq-go-sdk v0.0.0-00010101000000-000000000000
